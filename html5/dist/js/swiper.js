...
function applyCard() {
    ...
    $.ajax({
        ...
        data: {name:u_Name, code:u_Vcode,idNo:u_CardId, mobile:u_Iphone,batch:GetQueryString('batch'),ch:GetQueryString('ch'),product:window.sessionStorage.getItem('prodduct-zh')},
        dataType: "json",
        timeout: 15000,
